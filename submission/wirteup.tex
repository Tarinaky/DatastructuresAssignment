...
\begin{figure}[h!!]
$depth$ and $start$ are both parameters, representing the size of the desired word ladder and the first element respectively. $array$ is an array or dynamic array with length at least equal to $depth$.
...
\FOR i := 1 \TO depth \DO
	...
	\OD
\OD
\IF array | length equals | depth | |\DO
	|return | array 
\ELSE
